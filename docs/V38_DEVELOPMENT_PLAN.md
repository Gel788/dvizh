...
|------|---|---|---|--------|
| 0 Аудит | 3/6 | 1/1 | 2/3 | 🟡 |
| 1 Фронт v38 | 16/21 | — | 2/2 | 🟡 |
| 2 Auth | 0/4 | 0/7 | 0/3 | ⬜ отложено |
| 3 Privacy | 2/3 | 6/6 | 4/4 | 🟡 |
| 4 Today | 7/7 | 8/9 | 4/5 | 🟡 |
| 5 Feed | 6/6 | 12/12 | 6/6 | ✅ |
| 6 Move | 6/6 | 9/9 | 9/9 | ✅ |
| 7 Challenges | 6/6 | 8/8 | 3/4 | 🟡 |
| 8 Profile | 5/5 | 4/5 | 5/5 | 🟡 |
| 9 Calendar | 4/4 | 4/4 | 7/7 | ✅ |
| 10 Wishlist | 3/3 | 4/5 | 4/4 | 🟡 |
| 11 Disputes | 2/2 | 2/4 | 3/3 | 🟡 |
| 12 Together | 1/1 | 2/4 | 3/3 | 🟡 |
| 13 Medialist | 2/2 | 1/2 | 2/2 | 🟡 |
| 14 Search/Notif | 3/3 | 4/5 | 4/5 | 🟡 |
| 15 Deploy/QA | 2/4 | 3/4 | 2/3 | 🟡 |
| Launch rules | — | 8/8 | — | ✅ |

**Итого чеклист:** 193/229 `[x]` (~84%). **Отложено:** Auth SMS (14), Android/TestFlight (3), post-MVP (19).
...
*Документ создан: 2026-07-10. Последнее обновление: финальный launch-срез build 20.*
